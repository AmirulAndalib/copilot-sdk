...
<dependency>
    ...
    <version>1.0.13-preview.3</version>
</dependency>
```
...
```groovy
implementation 'com.github:copilot-sdk-java:1.0.13-preview.3'
```
...
<dependency>
    <groupId>com.github</groupId>
    <artifactId>copilot-sdk-java</artifactId>
    <version>1.0.14-preview.3-SNAPSHOT</version>
</dependency>
```
...
```groovy
implementation 'com.github:copilot-sdk-java:1.0.14-preview.3-SNAPSHOT'
```
